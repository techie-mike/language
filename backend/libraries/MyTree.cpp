...
bool Tree::callFunctionsView (nameTable* table, size_tree_t index) {
    if ((one_element[index].type_ == TYPE_OPERATOR/* || !strcmp(one_element[index].name_, "=")*/) && (*one_element[one_element[index].right_].name_ == '$'/* || *one_element[one_element[index].left_].name_ == '$'*/)) {
//        writeNameInTextCode (one_element[one_element[index].left_].name_);
